...
if uploaded_file is not None:
    ...
    for msg in st.session_state.messages:
        if isinstance(msg, HumanMessage):
            ...
            try:
                ...
                if isinstance(tool_output, dict) and tool_output.get("type") == "image":
    ...
    if prompt := st.chat_input("E.g., 'What is the correlation between column A and column B?'"):
        ...
        with st.spinner("🧠 Agent is thinking and writing code..."):
            ...
            final_state = eda_agent.invoke(inputs)
